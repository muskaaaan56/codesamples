...
$installer->run(
    "
    ALTER TABLE `customer_entity` ADD `uid` VARCHAR(25) NULL COMMENT 'User Id of the user.';
    "
);

$setup->removeAttribute('customer', 'user_status');
...
foreach (array('Active','Inactive','Created') as $sortOrder => $label) {
